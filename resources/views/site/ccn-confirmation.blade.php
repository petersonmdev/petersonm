...
<div class="page">
  ...
  <div class="right-panel">
    ...
    <form method="POST" action="{{ route('cha.confirmacao.store') }}">
            @csrf
      <div class="field">
        <label for="nome">Nome completo</label>
        <input type="text" id="nome" name="nome" placeholder="Ex: João da Silva" required autocomplete="name"
                   value="{{ old('nome') }}">
                @error('nome')
      ...
      <div class="field">
        ...
        <div class="select-wrap">
          <select id="acompanhantes" name="acompanhantes" required>
            <option value="" disabled selected>Selecione...</option>
            <option value="0">Vou sozinho(a) — apenas eu</option>
            <option value="1">+1 acompanhante (2 no total)</option>
            <option value="2">+2 acompanhantes (3 no total)</option>
            <option value="3">+3 acompanhantes (4 no total)</option>
            <option value="4">+4 acompanhantes (5 no total)</option>
    ...
    <p class="form-footer">
      Já confirmou? <a href="{{ route('cha.confirmados') }}">Ver lista de confirmados →</a><br>
      Quer dar um presente? <a href="{{ route('cha.presentes') }}">Ver sugestões →</a>
    </p>
  </div>
</div>
