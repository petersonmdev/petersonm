...
.jogo-wrap{
  ...
  background:linear-gradient(135deg, rgba(0,39,118,.5) 0%, rgba(0,77,38,.5) 100%);
  border-top:1px solid var(--border-dim);
  border-bottom:1px solid var(--border-dim);
}
.jogo-wrap::before{
  ...
  background:repeating-linear-gradient(90deg,
    ...
    rgba(255,255,255,.02) 119px,rgba(255,255,255,.02) 120px);
  pointer-events:none;
}
.jogo-inner{
...
.jogo-team{text-align:center;flex:1;min-width:140px}
.jogo-flag{font-size:2.8rem;display:block;margin-bottom:.4rem}
.jogo-name{
  font-family:'Bebas Neue',sans-serif;
...
.jogo-center{text-align:center;flex:0 0 auto}
.live-pill{
...
.live-dot{width:6px;height:6px;border-radius:50%;background:#fff;animation:blink 1.4s ease infinite}
@keyframes blink{0%,100%{opacity:1}50%{opacity:.25}}
.jogo-hora{
  font-family:'Bebas Neue',sans-serif;
  font-size:3.5rem;color:var(--amarelo);line-height:1;
}
.jogo-data{font-size:.72rem;font-weight:600;letter-spacing:.2em;text-transform:uppercase;color:var(--muted);margin-top:.3rem}
.vs-text{font-family:'Barlow Condensed',sans-serif;font-weight:700;font-size:.9rem;letter-spacing:.3em;color:rgba(245,196,0,.35)}
...
.footer-brand{font-family:'Barlow Condensed',sans-serif;font-weight:700;font-size:.75rem;letter-spacing:.2em;text-transform:uppercase;color:var(--muted)}
...
@media(max-width:900px){
  ...
  .jogo-inner{padding:2rem 1.5rem;justify-content:center;flex-direction:column;align-items:center}
...
<section class="hero">
  ...
  <div class="hero-left">
    ...
    <div class="hero-ctas">
      <a href="{{ route('cha.confirmacao') }}" class="btn-amarelo">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>
        Confirmar Presença
      </a>
      <a href="{{ route('cha.presentes') }}" class="btn-ghost">
...
<div class="data-strip">
  ...
  <div class="ds-item">
    ...
    <div>
      <span class="ds-label">Abertura</span>
      <span class="ds-val gold">18h · Jogo às 19h</span>
    </div>
  </div>
  <div class="ds-item">
    <div class="ds-icon">
    ...
    <div>
      ...
      <span class="ds-val">Verde · Amarelo · Azul</span>
    </div>
  </div>
  <div class="ds-item">
    <div class="ds-icon">
    ...
    <div>
      <span class="ds-label">Local</span>
      <span class="ds-val">Pós Confirmação</span>
    </div>
  </div>
</div>

<!-- ── SEÇÃO CASAL + DETALHES ── -->
<div class="section">
  <p class="s-label">Convite &amp; Detalhes</p>
  <h2 class="s-title">A <em>convocação</em> chegou</h2>
  <p class="s-lead">Nosso lar é novo, mas a festa é no estilo da Seleção. Confira tudo que você precisa saber.</p>

  <div class="showcase" style="margin-top:3.5rem">
    <div class="showcase-img" style="min-height:480px">
      <img src="{{ asset('images/cha/casal.jpg') }}" alt="Peterson e Amanda com a chave da casa nova" style="width:100%;height:100%;object-fit:cover;object-position:top center;display:block">
      <div class="showcase-overlay">
        <span class="showcase-caption">Peterson &amp; Amanda · Chá de Casa Nova 2026</span>
      </div>
    </div>
    <div class="showcase-info">
      <div class="info-row">
        <div class="info-icon-wrap">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a2 2 0 01-2-2v-6a2 2 0 012-2h8z"/></svg>
        </div>
        <div>
          <span class="info-tag">Cardápio</span>
          <p class="info-main">Comida de Buteco + Carreteiro</p>
          <p class="info-sub">Petiscos durante o jogo. Jantar: Carreteiro.</p>
        </div>
      </div>
      <div class="info-row">
        <div class="info-icon-wrap">
        ...
        <div>
          <span class="info-tag">Bebidas</span>
          <p class="info-main">Traga a sua favorita</p>
          <p class="info-sub">Geladeira compartilhada. Traga o que quiser!</p>
        </div>
      </div>
      <div class="info-row">
        <div class="info-icon-wrap">
        ...
        <div>
          <span class="info-tag">Dress Code</span>
          <p class="info-main">Camisa da Seleção ou Verde · Amarelo · Azul</p>
          <p class="info-sub">Vista as cores do Brasil e entre no clima da Copa!</p>
        </div>
      </div>
      <div class="info-row">
        <div class="info-icon-wrap" style="background:rgba(245,196,0,.1);border-color:rgba(245,196,0,.2);color:var(--amarelo)">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
        </div>
        <div>
          <span class="info-tag" style="color:var(--amarelo)">Local</span>
          <p class="info-main">Enviado após a confirmação</p>
          <p class="info-sub">Confirme sua presença e receba o endereço.</p>
        </div>
      </div>
      <a href="{{ route('cha.confirmacao') }}" class="btn-amarelo" style="margin-top:.5rem;justify-content:center">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>
        Confirmar Presença
      </a>
    </div>
...
<!-- ── JOGO BANNER ── -->
<div class="jogo-wrap">
  <div class="jogo-inner">
    <div class="jogo-team">
      <span class="jogo-flag">🇧🇷</span>
      <span class="jogo-name">Brasil</span>
    </div>
    <div class="jogo-center">
      <div class="live-pill"><span class="live-dot"></span>Ao Vivo</div>
      <div class="jogo-hora">19:00</div>
      <p class="vs-text" style="margin:.3rem 0">VS</p>
      <p class="jogo-data">13 de Junho · 2026</p>
    </div>
    <div class="jogo-team">
      <span class="jogo-flag">🇲🇦</span>
      <span class="jogo-name">Marrocos</span>
    </div>
  </div>
</div>
